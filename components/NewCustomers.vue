<template>
  <section class="mt-5">
    ...
    <div
      class="mt-5 flex w-full items-start overflow-x-auto rounded-lg border bg-background p-5 scrollbar-thin scrollbar-thumb-input scrollbar-thumb-rounded-md"
    >
      ...
      <template v-for="(n, i) in data" :key="i">
        <div class="flex flex-col shrink-0 items-center gap-2 px-2">
          <img
